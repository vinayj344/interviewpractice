 ...
 *
 */
package org.mercury.storefront.controllers.pages;
...
import org.mercury.facades.subTotal.TotalWithoutTaxFacade;
...
public class CartPageController extends AbstractCartPageController
{
	...
	@Resource(name = "totalWithoutTaxFacade")
	private TotalWithoutTaxFacade totalWithoutTaxFacade;
	...
	public String showCart(final Model model) throws CMSItemNotFoundException, CommerceCartModificationException // NOSONAR
	{
		...
		final SubTotalWithoutTaxData totalWithoutTax = totalWithoutTaxFacade.getOrderTotalWithoutTax();
		model.addAttribute("subValueWithoutTax", totalWithoutTax);
