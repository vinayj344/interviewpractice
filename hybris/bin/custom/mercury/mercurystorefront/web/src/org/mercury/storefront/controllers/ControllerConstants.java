 ...
 *
 */
package org.mercury.storefront.controllers;
...
public interface ControllerConstants
{
	...
	interface Actions
	{
		interface Cms // NOSONAR
		{
			...
			String RainySeasonOffersComponent = _Prefix + RainySeasonOfferComponentModel._TYPECODE + _Suffix; // NOSONAR
		}
	}
	...
	interface Views
	{
		...
		interface Pages
		{
			...
			interface Offers // NOSONAR
			{
				String RainySeasonOffer = "pages/offer/rainySeasonPage"; // NOSONAR
			}
		}
