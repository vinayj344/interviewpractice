...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mercurystorefront/electronics/en",
						"https://electronics.local:9002/mercurystorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mercurystorefront/electronics/en",
						"https://electronics.local:9002/mercurystorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mercurystorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/mercurystorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mercurystorefront/electronics/en",
						"https://electronics.local:9002/mercurystorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mercurystorefront",
						"https://electronics.local:9002/mercurystorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mercurystorefront",
						"https://electronics.local:9002/mercurystorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/mercurystorefront/electronics/en",
						"https://electronics.local:9002/mercurystorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
