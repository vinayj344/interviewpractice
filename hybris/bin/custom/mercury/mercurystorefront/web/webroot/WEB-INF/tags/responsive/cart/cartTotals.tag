...
<div class="cart-totals">
    <div class="col-xs-8 col-sm-9 col-md-10 col-lg-11"><spring:theme code="basket.page.totals.subtotal"/></div> <!-- cartData.subTotal -->
    <div class="col-xs-4 col-sm-3 col-md-2 col-lg-1"><ycommerce:testId code="Order_Totals_Subtotal"><format:price priceData="${subValueWithoutTax}"/></ycommerce:testId></div>
