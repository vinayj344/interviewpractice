 ...
 *  
 */
package org.mercury.test.setup;
...
import org.mercury.test.constants.MercuryTestConstants;
import org.mercury.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MercuryTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/mercurytest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/mercurytest/import/reviews.impex");
			...
			importImpexFile(context, "/mercurytest/import/cstickets.impex");
		}
	}
}
