 ...
 *  
 */
package org.mercury.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(MercuryFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MercuryFulfilmentProcessConstants.PARENT_PROCESS);
