 ...
 * ----------------------------------------------------------------
 */
package org.mercury.core.constants;
...
public class GeneratedMercuryCoreConstants
{
	public static final String EXTENSIONNAME = "mercurycore";
	public static class TC
	{
		...
		public static final String EVERYREPLY = "EveryReply".intern();
		public static final String OFFERFORMENTRY = "OfferFormEntry".intern();
		public static final String RAINYSEASONOFFERCOMPONENT = "RainySeasonOfferComponent".intern();
	...
	protected GeneratedMercuryCoreConstants()
	{
		// private constructor
	}
